...
You must submit to this competition using the provided evaluation API, which ensures that models do not peek forward in time.
...
The extra hour is to help protect against time-out failures due to the extended size of the test set. You are still responsible for ensuring your submission completes within the 9 hour limit, however.
...
## Citation
Maggie, Naruaki Takano, Rintaro Rai, Sohier Dane, and Tomoya Kitayama. MITSUI&CO. Commodity Prediction Challenge. https://kaggle.com/competitions/mitsui-commodity-prediction-challenge, 2025. Kaggle.
